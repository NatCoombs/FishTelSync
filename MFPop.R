...
# MFPop generates surrogate sample sets using the MFSurrs & ranks the input sample set LCS output against 
# their mean synchrony, their cluster strength score a la cluseigen from wsyn, & the 90th percentile 
# synchrony
